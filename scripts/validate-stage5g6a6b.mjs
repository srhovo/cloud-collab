...
const requiredFiles = [
  ...
  'docs/阶段5G6A6B_EdgeOne联合验收操作清单.md',
  ...
  'src/server/stage5g6a6b_cleanup_exact_v1.js',
  ...
  'tests/stage5g6a6b_browser_acceptance.py',
  'tests/stage5g6a6b_browser_cleanup.py',
];
...
const cleanupHttp = file('src/server/stage5g6a6b_cleanup_http_v1.js');
const cleanupCore = file('src/server/stage5g6a6b_cleanup_exact_v1.js');
...
check(cleanupHttp.includes("from './stage5g6a6b_cleanup_exact_v1.js'"), '清理HTTP只使用精确白名单核心');
