...
const activeShellCheck = `check('candidate uses the approved 8.2.31 shell and retains Stage4C compatibility', output.includes("const APP_VERSION = '8.2.31';") && output.includes('<title>码单器8.2.31（公共协作发布候选版）</title>'));`;
