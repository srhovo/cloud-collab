...
export const handleAdminDeviceListByMode = (c, d = {}) => dispatch(
  c, d, handleAdminDeviceListRequest, handleProductionAdminDeviceListRequest,
);
export const handleAdminDeviceDetailByMode = (c, d = {}) => dispatch(
  c, d, handleAdminDeviceDetailRequest, handleProductionAdminDeviceDetailRequest,
);
export const handleAdminDeviceTrustByMode = (c, d = {}) => dispatch(
  c, d, handleAdminDeviceTrustRequest, handleProductionAdminDeviceTrustRequest,
);
export const handleAdminDeviceRevokeTrustByMode = (c, d = {}) => dispatch(
  c, d, handleAdminDeviceRevokeTrustRequest, handleProductionAdminDeviceRevokeTrustRequest,
);
export const handleAdminDeviceBlockByMode = (c, d = {}) => dispatch(
  c, d, handleAdminDeviceBlockRequest, handleProductionAdminDeviceBlockRequest,
);
export const handleAdminDeviceUnblockByMode = (c, d = {}) => dispatch(
  c, d, handleAdminDeviceUnblockRequest, handleProductionAdminDeviceUnblockRequest,
);
