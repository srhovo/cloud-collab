...
export const PRODUCTION_ADMIN_SESSION_COOKIE = 'cloud_collab_admin_session';
export const PRODUCTION_ADMIN_SESSION_COOKIE_PATH = '/api/admin';
...
export function readProductionAdminAuthConfig(env = {}) {
  ...
  return Object.freeze({
    ...
    sessionCookie: PRODUCTION_ADMIN_SESSION_COOKIE,
    sessionCookiePath: PRODUCTION_ADMIN_SESSION_COOKIE_PATH,
