...
const SAFE_PUBLIC_PATTERNS = Object.freeze([
  ...
  new RegExp(`^submissions/${STAGE5G6A6B_LIBRARY_ID}/(?:pending|matches)/.+\\.json$`),
  new RegExp(`^reviews/${STAGE5G6A6B_LIBRARY_ID}/.+\\.json$`),
  new RegExp(`^public/${STAGE5G6A6B_LIBRARY_ID}/.+\\.json$`),
  new RegExp(`^audit/[0-9]{4}/(?:0[1-9]|1[0-2])/(?:au_v1|sau_v1|srau_v1)_${HASH_43}\\.json$`),
]);
